...
from diagrams.aws.security import IAM, IAMRole, IAMPolicy
from diagrams.aws.general import User
from diagrams.aws.compute import Lambda
from diagrams.aws.integration import StepFunctions
from diagrams.aws.security.IdentityAndAccessManagementIamMfaToken import IAMMfaToken

# Create a diagram for the AWS Account Creation Flow
with Diagram("AWS Account Creation Flow", show=False):
    ...
    with Cluster("IAM Access Setup"):
        ...
        admin_access = IAMPolicy("Admin Access Policy")
        user_access = IAMPolicy("User Access Policy")
